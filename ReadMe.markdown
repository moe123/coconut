...
`experiences` including Qt Core. The author doesn't like argument ; reminding this is a sparetime and single-handed project ; let us make a room for it anyway ; hence, for the same data-set, 
