...
void hash::sha1::process_block(const void * block)
{
	...
	for (i = 16; i < 80; i++) {
		words[i] = builtins::hash_sha1_rot(words[i - 3]
			^ words[i - 8]
			^ words[i - 14]
			^ words[i - 16],
		1);
	...
	for (i = 0; i < 4; i++) {
		...
		e += builtins::hash_sha1_rot(a, 5)
			+ builtins::hash_sha1_f1(b, c, d)
			+ words[offset + 0] + 0x5A827999;
		b = builtins::hash_sha1_rot(b, 30);
		d += builtins::hash_sha1_rot(e, 5)
			+ builtins::hash_sha1_f1(a, b, c)
			+ words[offset + 1] + 0x5A827999;
		a = builtins::hash_sha1_rot(a, 30);
		c += builtins::hash_sha1_rot(d, 5)
			+ builtins::hash_sha1_f1(e, a, b)
			+ words[offset + 2] + 0x5A827999;
		e = builtins::hash_sha1_rot(e, 30);
		b += builtins::hash_sha1_rot(c, 5)
			+ builtins::hash_sha1_f1(d, e, a)
			+ words[offset + 3] + 0x5A827999;
		d = builtins::hash_sha1_rot(d, 30);
		a += builtins::hash_sha1_rot(b, 5)
			+ builtins::hash_sha1_f1(c, d, e)
			+ words[offset + 4] + 0x5A827999;
		c = builtins::hash_sha1_rot(c, 30);
	}
	
	for (i = 4; i < 8; i++) {
		std::size_t offset = 5 * i;
		e += builtins::hash_sha1_rot(a, 5)
			+ builtins::hash_sha1_f2(b, c, d)
			+ words[offset + 0] + 0x6ED9EBA1;
		b = builtins::hash_sha1_rot(b, 30);
		d += builtins::hash_sha1_rot(e, 5)
			+ builtins::hash_sha1_f2(a, b, c)
			+ words[offset + 1] + 0x6ED9EBA1;
		a = builtins::hash_sha1_rot(a, 30);
		c += builtins::hash_sha1_rot(d, 5)
			+ builtins::hash_sha1_f2(e, a, b)
			+ words[offset + 2] + 0x6ED9EBA1;
		e = builtins::hash_sha1_rot(e, 30);
		b += builtins::hash_sha1_rot(c, 5)
			+ builtins::hash_sha1_f2(d, e, a)
			+ words[offset + 3] + 0x6ED9EBA1;
		d = builtins::hash_sha1_rot(d, 30);
		a += builtins::hash_sha1_rot(b, 5)
			+ builtins::hash_sha1_f2(c, d, e)
	...
	for (i = 8; i < 12; i++) {
		std::size_t offset = 5 * i;
		e += builtins::hash_sha1_rot(a, 5)
			+ builtins::hash_sha1_f3(b, c, d)
			+ words[offset + 0] + 0x8F1BBCDC;
		b = builtins::hash_sha1_rot(b, 30);
		d += builtins::hash_sha1_rot(e, 5)
			+ builtins::hash_sha1_f3(a, b, c)
			+ words[offset + 1] + 0x8F1BBCDC;
		a = builtins::hash_sha1_rot(a, 30);
		c += builtins::hash_sha1_rot(d, 5)
			+ builtins::hash_sha1_f3(e, a, b)
			+ words[offset + 2] + 0x8F1BBCDC;
		e = builtins::hash_sha1_rot(e, 30);
		b += builtins::hash_sha1_rot(c, 5)
			+ builtins::hash_sha1_f3(d, e, a)
			+ words[offset + 3] + 0x8F1BBCDC;
		d = builtins::hash_sha1_rot(d, 30);
		a += builtins::hash_sha1_rot(b, 5)
			+ builtins::hash_sha1_f3(c, d, e)
